...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("22/05/2021"), "Partiu Viagem", "Vou viajar para Ubatuba", maria);
		Post post2 = new Post(null, sdf.parse("22/05/2021"), "cheguei Ubta", "Salve a Natureza", maria);
